...
/**
 * 
 * @ClassName: MyJoinOrInvitationList
 * @Description: 我参加的/我发起的
 * @author 肖邦
 * @date 2015-1-21 下午3:31:42
 * 
 */
public class MyJoinOrInvitation implements Serializable{
	public static final long serialVersionUID = -5491140343077849537L;
